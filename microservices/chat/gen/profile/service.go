...
type Service interface {
	...
	GetProfileByID(context.Context, *GetProfileByIDPayload) (res *GetProfileByIDResult, err error)
}
...
// MethodKey key.
var MethodNames = [3]string{"get_profile", "update_profile", "get_profile_by_id"}

// GetProfileByIDPayload is the payload type of the profile service
// get_profile_by_id method.
type GetProfileByIDPayload struct {
	// JWT token
	Token *string
	// User ID to lookup
	UserID string
...
// GetProfileByIDResult is the result type of the profile service
// get_profile_by_id method.
