...
import (
	...
	bffsvr "object-t.com/hackz-giganoto/microservices/bff/gen/grpc/bff/server"
)

// handleGRPCServer starts configures and starts a gRPC server on the given
// URL. It shuts down the server if any error is received in the error channel.
func handleGRPCServer(ctx context.Context, u *url.URL, bffEndpoints *bff.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
	...
	// responses.
	var (
		bffServer *bffsvr.Server
	)
	{
		bffServer = bffsvr.New(bffEndpoints, nil, nil)
	}
	...
	bffpb.RegisterBffServer(srv, bffServer)
