...
import (
	...
	"goa.design/clue/log"
	bffapi "object-t.com/hackz-giganoto/microservices/bff"
...
func main() {
	...
	config := telemetry.DefaultConfig("bff-service")
	...
	{
		bffSvc = bffapi.NewBff()
	}

	// Wrap the services in endpoints that can be invoked from other services
	// potentially running in different processes.
	var (
		bffEndpoints *bff.Endpoints
	)
	{
		bffEndpoints = bff.NewEndpoints(bffSvc)
		bffEndpoints.Use(debug.LogPayloads())
		bffEndpoints.Use(log.Endpoint)
	}
