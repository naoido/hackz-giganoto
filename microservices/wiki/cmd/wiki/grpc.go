...
import (
	...
	wikisvr "object-t.com/hackz-giganoto/microservices/wiki/gen/grpc/wiki/server"
	wiki "object-t.com/hackz-giganoto/microservices/wiki/gen/wiki"
)

// handleGRPCServer starts configures and starts a gRPC server on the given
// URL. It shuts down the server if any error is received in the error channel.
func handleGRPCServer(ctx context.Context, u *url.URL, wikiEndpoints *wiki.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
	...
	// responses.
	var (
		wikiServer *wikisvr.Server
	)
	{
		wikiServer = wikisvr.New(wikiEndpoints, nil)
	}
	...
	wikipb.RegisterWikiServer(srv, wikiServer)
