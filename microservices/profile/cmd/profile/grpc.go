...
import (
	...
	profilesvr "object-t.com/hackz-giganoto/microservices/profile/gen/grpc/profile/server"
	profile "object-t.com/hackz-giganoto/microservices/profile/gen/profile"
)

// handleGRPCServer starts configures and starts a gRPC server on the given
// URL. It shuts down the server if any error is received in the error channel.
func handleGRPCServer(ctx context.Context, u *url.URL, profileEndpoints *profile.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
	...
	{
		profileServer = profilesvr.New(profileEndpoints, nil)
	}
