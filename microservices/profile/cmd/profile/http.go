...
import (
	...
	profilesvr "object-t.com/hackz-giganoto/microservices/profile/gen/http/profile/server"
	profile "object-t.com/hackz-giganoto/microservices/profile/gen/profile"
)

// handleHTTPServer starts configures and starts a HTTP server on the given
// URL. It shuts down the server if any error is received in the error channel.
func handleHTTPServer(ctx context.Context, u *url.URL, profileEndpoints *profile.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
	...
	{
		eh := errorHandler(ctx)
		profileServer = profilesvr.New(profileEndpoints, mux, dec, enc, eh, nil)
	}
